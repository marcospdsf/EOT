 ...
 * @author hendrik
 */
public class PlayerWeaponbagSlot extends PlayerSlot {
	 ...
	 * @param player player
	 */
	public PlayerWeaponbagSlot(final String player) {
		super(player);
	}

	@Override
	public boolean isReachableForTakingThingsOutOfBy(final Entity entity) {
		if (!mayAccessScrollBag(entity)) {
			setErrorMessage("Your weaponbag is broken. You should look for someone who can fix it.");
			return false;
		}
	 ...
	 */
	private boolean mayAccessScrollBag(Entity entity) {
		if (!(entity instanceof Player)) {
			return false;
		}
		Player player = (Player) entity;
		return (player.getFeature("weaponbag") != null);
	}
}
