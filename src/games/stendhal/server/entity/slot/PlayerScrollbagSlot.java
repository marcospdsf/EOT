 ...
 * @author hendrik
 */
public class PlayerScrollbagSlot extends PlayerSlot {
	 ...
	 * @param player player
	 */
	public PlayerScrollbagSlot(final String player) {
		super(player);
	}
	...
	public boolean isReachableForTakingThingsOutOfBy(final Entity entity) {
		if (!mayAccessScrollBag(entity)) {
			setErrorMessage("Your scrollbag is broken. You should look for someone who can fix it.");
			return false;
		}
	...
	private boolean mayAccessScrollBag(Entity entity) {
		...
		return (player.getFeature("scrollbag") != null);
	}
}
