...
//		player.addAttribute("private_text", Type.LONG_STRING, (byte) (Definition.HIDDEN | Definition.VOLATILE));
		...
		player.addAttribute("miningLevel", Type.INT, Definition.HIDDEN);
		player.addAttribute("mining_xp", Type.INT, Definition.HIDDEN);
		...
		// Bank system
		player.addRPSlot("bank", 100, Definition.HIDDEN);
		player.addRPSlot("bank_ados", 100, Definition.HIDDEN);
		player.addRPSlot("bank_deniran", 100, Definition.HIDDEN);
		player.addRPSlot("zaras_chest_ados", 100, Definition.HIDDEN);
		player.addRPSlot("bank_fado", 100, Definition.HIDDEN);
		player.addRPSlot("bank_nalwor", 100, Definition.HIDDEN);
		player.addRPSlot("bank_tsoh", 100, Definition.HIDDEN);
		player.addRPSlot("bank_zakopane", 100, Definition.HIDDEN);
		player.addRPSlot("yama_semos_bank_1", 100, Definition.HIDDEN);
