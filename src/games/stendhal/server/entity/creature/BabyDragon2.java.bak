 ...
 *
 */
public class BabyDragon2 extends Pet {

	/** the logger instance. */
	private static final Logger logger = Logger.getLogger(BabyDragon2.class);
	...
	public static void generateRPClass() {
		try {
			final RPClass baby_dragonn = new RPClass("baby_dragonn");
			baby_dragonn.isA("pet");
	 ...
	 */
	public BabyDragon2(final Player owner) {
		super();
		setOwner(owner);
		setUp();
		setRPClass("baby_dragonn");
		put("type", "baby_dragonn");
	 ...
	 */
	public BabyDragon2(final RPObject object, final Player owner) {
		super(object, owner);
	...
	public void grow() {
		...
		if (!currentTitle.startsWith("baby dragonn"))	{
