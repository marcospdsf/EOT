...
public final class ShopList {
	...
	static {
		...
		shops.add("buyores", "coal", 20);
		shops.add("buyores", "iron", 40);
		shops.add("buyores", "silver nugget", 70);
		shops.add("buyores", "gold nugget", 150);
		shops.add("buyores", "mithril nugget", 330);
		...
		shops.add("buycheng", "wielka perÅ‚a", 1500);
		shops.add("buycheng", "bryÅ‚ka mithrilu", 10);
		shops.add("buycheng", "chaplet", 10000);
		//bronek kupuje:
		shops.add("buydragonitems", "wolf claws", 5);
		shops.add("buydragonitems", "niedÅºwiedzie pazury", 8);
		shops.add("buydragonitems", "pazury tygrysie", 100);
		shops.add("buydragonitems", "green dragon claw", 5000);
		shops.add("buydragonitems", "pazur niebieskiego smoka", 5000);
		shops.add("buydragonitems", "red dragon claw", 5000);
		shops.add("buydragonitems", "black dragon's claw", 10000);
		shops.add("buydragonitems", "pazur zÅ‚otego smoka", 15000);


		shops.add("buykacper", "Å›nieÅ¼ka", 5);
		shops.add("buykacper", "kamienie", 6);
		shops.add("buykacper", "bryÅ‚a lodu", 8);
		//rzeznik kupuje
		shops.add("buymieso", "miÄ™so", 15); 
		shops.add("buymieso", "ham", 25);
		shops.add("buymieso", "chicken", 12);
		shops.add("buymieso", "steak", 35);
		//waldek kupuje
		shops.add("buyowoce", "wisienka", 8);
		shops.add("buyowoce", "jabÅ‚ko", 5);
		shops.add("buyowoce", "jabÅ‚ko niezgody", 15);
		shops.add("buyowoce", "poziomka", 5);
		shops.add("buyowoce", "strawberry", 8);
		...
		shops.add("buyrareitems", "chusta gÃ³ralska", 200);
		shops.add("buyrareitems", "cuha gÃ³ralska", 200);
		shops.add("buyrareitems", "gÃ³ralska spÃ³dnica", 200);
		shops.add("buyrareitems", "gÃ³ralski gorset", 300);
		shops.add("buyrareitems", "gÃ³ralski kapelusz", 300);
		shops.add("buyrareitems", "beech pants", 300);
		shops.add("buyrareitems", "polish light shield", 500);
		shops.add("buyrareitems", "polish wooden shield", 500);
		shops.add("buyrareitems", "ciupaga", 1000);
		shops.add("buyrareitems", "chaplet", 1000);
		shops.add("buyrareitems", "pas zbÃ³jecki", 1000);
		shops.add("buyrareitems", "polish chainmail", 1000);
		shops.add("buyrareitems", "polska pÅ‚ytowa tarcza", 2000);
		shops.add("buyrareitems", "spinka", 2000);
		shops.add("buyrareitems", "polska tarcza ciÄ™Å¼ka", 1500);
		shops.add("buyrareitems", "zÅ‚ota ciupaga", 5000);
		shops.add("buyrareitems", "cerimonial sword", 1000000);

		shops.add("buyrybak", "cod", 5);
		shops.add("buyrybak", "palia alpejska", 7);
		shops.add("buyrybak", "pÅ‚otka", 7);
		shops.add("buyrybak", "makrela", 8);
		shops.add("buyrybak", "okoÅ„", 8);
		shops.add("buyrybak", "pokolec", 9);
		shops.add("buyrybak", "pstrÄ…g", 9);
		shops.add("buyrybak", "bÅ‚azenek", 10);
		
		shops.add("buyryby", "cod", 6);
		shops.add("buyryby", "palia alpejska", 7);
		shops.add("buyryby", "pÅ‚otka", 7);
		shops.add("buyryby", "makrela", 8);
		shops.add("buyryby", "okoÅ„", 9);
		shops.add("buyryby", "pokolec", 9);
		shops.add("buyryby", "pstrÄ…g", 9);
		shops.add("buyryby", "bÅ‚azenek", 11);
		//bogus kupuje :
		shops.add("buyskin", "piÃ³rko", 3);
		shops.add("buyskin", "skÃ³ra lwa", 2500);
		shops.add("buyskin", "skÃ³ra zielonego smoka", 2600);
		shops.add("buyskin", "skÃ³ra czerwonego smoka", 2600);
		shops.add("buyskin", "skÃ³ra niebieskiego smoka", 2600);
		shops.add("buyskin", "skÃ³ra tygrysa", 1000);
		shops.add("buyskin", "skÃ³ra zÅ‚otego smoka", 2700);
		shops.add("buyskin", "skÃ³ra czarnego smoka", 3300);
		shops.add("buyskin", "skÃ³ra xenocium", 450);

		shops.add("buywarzywa", "marchew", 2);
		shops.add("buywarzywa", "saÅ‚ata", 2);
		shops.add("buywarzywa", "pieczarka", 4);
		shops.add("buywarzywa", "opieÅ„ka miodowa", 6);
		shops.add("buywarzywa", "pomidor", 5);
		shops.add("buywarzywa", "kapusta", 6);
		shops.add("buywarzywa", "borowik", 6);
		shops.add("buywarzywa", "szpinak", 6);
		shops.add("buywarzywa", "brokuÅ‚", 7);
		shops.add("buywarzywa", "por", 7);
		shops.add("buywarzywa", "kalafior", 8);
		shops.add("buywarzywa", "cebula", 8);
		shops.add("buywarzywa", "cukinia", 10);
		//mysliwy kupuje
		shops.add("buyzeby", "kieÅ‚ wilczy", 10);
		shops.add("buyzeby", "kieÅ‚ niedÅºwiedzi", 15);
		shops.add("buyzeby", "dziÃ³b ptaka", 200);
		shops.add("buyzeby", "zÄ…b potwora", 400);
		shops.add("buyzeby", "kieÅ‚ smoka", 500);
		shops.add("buyzeby", "kieÅ‚ zÅ‚otej kostuchy", 5000);
		//zielarka kupuje
		...
		shops.add("juhas", "home scroll", 400);
		shops.add("juhas", "empty scroll", 1000);
		shops.add("juhas", "ados city scroll", 600);
		shops.add("juhas", "fado city scroll", 650);
		shops.add("juhas", "kalavan city scroll", 800);
		shops.add("juhas", "kirdneh city scroll", 600);

		shops.add("mecz", "bilet na mecz", 250);
		shops.add("mecz", "piÅ‚ka", 500);
		...
		shops.add("edscroll", "zwÃ³j edragons", 200);

		shops.add("sellwarzywairek", "marchew", 5);
		shops.add("sellwarzywairek", "saÅ‚ata", 10);
		...
		//Jagna sprzedaje:
		shops.add("urodziny", "hops juice", 8); 
		shops.add("urodziny", "napÃ³j z winogron", 10); 
		shops.add("urodziny", "napÃ³j z oliwkÄ…", 50); 
		shops.add("urodziny", "shake waniliowy", 100); 
		shops.add("urodziny", "shake czekoladowy", 100); 
		shops.add("urodziny", "miÄ™so", 20); 
		shops.add("urodziny", "ham", 30); 
		shops.add("urodziny", "hotdog", 120); 
		shops.add("urodziny", "hotdog z serem", 140); 
		shops.add("urodziny", "sandwich z tuÅ„czykiem", 340); 
		shops.add("urodziny", "sandwich", 310); 
		shops.add("urodziny", "tabliczka czekolady", 80); 
		shops.add("urodziny", "lukrecja", 80); 

		shops.add("wawel", "zwÃ³j krakowski", 250);
		shops.add("wawel", "zwÃ³j tatrzaÅ„ski", 350);

		shops.add("zrc", "zwÃ³j zrc", 200);
		shops.add("zrc", "zwÃ³j ados", 600);
		shops.add("zrc", "niezapisany zwÃ³j", 2000);
		shops.add("zrc", "zwÃ³j tatrzaÅ„ski", 250);
