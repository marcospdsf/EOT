...
public abstract class RPEntity extends GuidedEntity {
	...
	private static final float CLOAK_DEF_MULTIPLIER = 2.0f;
...
System.out.printf("  drop: %2d %2d\n", attackerRoll, defenderRoll);
	...
	public boolean hasRing2() {
		return isEquippedItemClass("finger2", "ring2");
	}

	public Item getRing2() {
		return getEquippedItemClass("finger2", "ring2");
	}
