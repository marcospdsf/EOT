/* $Id: Skrzynka.java,v 1.7 2010/09/19 02:23:49 nhnb Exp $ */
/***************************************************************************
...
public class Skrzynka extends Box {
	...
	private static final String[] ITEMS = { "greater potion", "jabłko niezgody",
			"sandwich", "wisienka", "blue elf cloak", "zwój przywołania", "bilet turystyczny",
			"zwój tatrzański" };
