/* $Id: SourceCarbuncle.java,v 1.4 2011/02/13 15:28:45 edi18028 Exp $ */
/***************************************************************************
 ...
 * @changes artur
 */
public class SourceCarbuncle extends PlayerActivityEntity {
	...
	public static void generateRPClass() {
		final RPClass rpclass = new RPClass("source_carbuncle");
		rpclass.isA("entity");
	}
	...
	protected void onStarted(final Player player) {
		player.sendPrivateText("Rozpocząłeś wydobywanie rubyów.");
	}
}
