/* $Id: SourceSulfur.java,v 1.4 2011/02/13 15:28:45 edi18028 Exp $ */
/***************************************************************************
 ...
 * @changes artur
 */
public class SourceSulfur extends PlayerActivityEntity {
	private static final Logger logger = Logger.getLogger(SourceSulfur.class);
	...
	public static void generateRPClass() {
		final RPClass rpclass = new RPClass("source_sulfur");
		rpclass.isA("entity");
	}
	...
	protected boolean isPrepared(final Player player) {
		...
		player.sendPrivateText("Potrzebujesz kilofa do wydobywania siarki.");
		return false;
	}
	...
	protected void onStarted(final Player player) {
		player.sendPrivateText("Rozpocząłeś wydobywanie siarki.");
	}
}
