/* $Id: SourceIron.java,v 1.4 2011/02/13 15:28:45 edi18028 Exp $ */
/***************************************************************************
 ...
 * @changes artur
 */
public class SourceIron extends PlayerActivityEntity {
	private static final Logger logger = Logger.getLogger(SourceIron.class);
	...
	public static void generateRPClass() {
		final RPClass rpclass = new RPClass("source_iron");
		rpclass.isA("entity");
	}
	...
	protected boolean isPrepared(final Player player) {
		...
		player.sendPrivateText("Potrzebujesz kilofa i liny do wydobywania rudy żelaza.");
		return false;
	}
