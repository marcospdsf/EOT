/* $Id: AtkTwoHundred.java,v 1.76 2011/11/13 17:13:16 kymara edited by szyg Exp $ */
/***************************************************************************
 ...
 */
public class AtkTwoHundred extends AbstractQuest {

	private static final String QUEST_SLOT = "AtkTwoHundred";
	...
	private void getQuest() {
		final SpeakerNPC npc = npcs.get("Tadeusz");
	...
	private void completeQuest() {
		...
		actions.add(new IncreaseAtkXPAction(200));
	...
	public List<String> getHistory(final Player player) {
		...
		if (repetitions > 0) {
			res.add("Przyniosłem kartkę Tadeuszowi "
