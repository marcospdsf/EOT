/* $Id: DefFiveThousand.java,v 1.76 2011/11/13 17:13:16 kymara edited by szyg Exp $ */
/***************************************************************************
 ...
 */
public class DefFiveThousand extends AbstractQuest {

	private static final String QUEST_SLOT = "DefFiveThousand";
	...
	private static void buildItemsMap() {
		...
		items.put("kartka (5000) obrony",1);
	}
	...
	private void getQuest() {
		final SpeakerNPC npc = npcs.get("Jan");
	...
	private void completeQuest() {
		...
		actions.add(new IncreaseDefXPAction(5000));
	...
	public List<String> getHistory(final Player player) {
		...
		if (repetitions > 0) {
			res.add("Przyniosłem kartkę Janowi "
