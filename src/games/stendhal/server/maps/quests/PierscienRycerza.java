...
import org.apache.log4j.Logger;
	...
	private void requestItem() {
		...
		monetaactions.add(new DropItemAction("iron",40));
		monetaactions.add(new DropItemAction("gold bar",40));
		monetaactions.add(new DropItemAction("bryłka mithrilu",30));
		monetaactions.add(new DropItemAction("pierścień mieszczanina",1));
		monetaactions.add(new DropItemAction("skull shield",1));
		...
		npc.add(ConversationStates.ATTENDING, Arrays.asList("wyposażenie", "wyposazenie","przedmioty"),
			...
			new PlayerHasItemWithHimCondition("iron",40),
			new PlayerHasItemWithHimCondition("gold bar",40),
			new PlayerHasItemWithHimCondition("bryłka mithrilu",30),
			new PlayerHasItemWithHimCondition("pierścień mieszczanina",1),
			new PlayerHasItemWithHimCondition("skull shield",1),
		...
		npc.add(ConversationStates.ATTENDING, Arrays.asList("wyposażenie", "wyposazenie", "przedmioty"),
				new AndCondition(new QuestInStateCondition(QUEST_SLOT,"przedmioty"),
								 new NotCondition(
								 new AndCondition(new PlayerHasItemWithHimCondition("iron",40),
												  new PlayerHasItemWithHimCondition("gold bar",40),
												  new PlayerHasItemWithHimCondition("bryłka mithrilu",30),
												  new PlayerHasItemWithHimCondition("pierścień mieszczanina",1),
												  new PlayerHasItemWithHimCondition("skull shield",1),
	...
	public List<String> getHistory(final Player player) {
			...
			res.add("Edgard poprosił abym mu dostarczył potrzebne przedmioty. Jeżeli nie będę pamintł co mam przynieść mam powiedzieć przypomnij.");
