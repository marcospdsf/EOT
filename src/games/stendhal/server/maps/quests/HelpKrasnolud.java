...
public class HelpKrasnolud extends AbstractQuest {
	...
	final SpeakerNPC npc = npcs.get("Wielkolud");
		...
		armoractions.add(new DropItemAction("red dragon skin",30));
		armoractions.add(new DropItemAction("green dragon skin",30));
		armoractions.add(new DropItemAction("skóra niebieskiego smoka",30));
		armoractions.add(new DropItemAction("black dragon skin",60));
		armoractions.add(new DropItemAction("golden dragon skin",10));
		armoractions.add(new EquipItemAction("blue armor"));
		armoractions.add(new IncreaseXPAction(1000));
		...
		npc.add(ConversationStates.ATTENDING,  Arrays.asList("wielkolud", "zbroja", "armor"),
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, "armor"),
								new PlayerHasItemWithHimCondition("red dragon skin",30),
								new PlayerHasItemWithHimCondition("green dragon skin",30),
								new PlayerHasItemWithHimCondition("skóra niebieskiego smoka",30),
								new PlayerHasItemWithHimCondition("black dragon skin",60),
								new PlayerHasItemWithHimCondition("golden dragon skin",10)),
		...
		npc.add(ConversationStates.ATTENDING,  Arrays.asList("wielkolud", "zbroja", "armor"),
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, "armor"),
								new NotCondition(
												new AndCondition(new PlayerHasItemWithHimCondition("red dragon skin",30),
																new PlayerHasItemWithHimCondition("green dragon skin",30),
																new PlayerHasItemWithHimCondition("skóra niebieskiego smoka",30),
																new PlayerHasItemWithHimCondition("black dragon skin",60),
																new PlayerHasItemWithHimCondition("golden dragon skin",10)))),
				ConversationStates.ATTENDING, "Potrzebuję 30 skór czerwonego smoka, 30 skór niebieskiego smoka, 30 skór zielonego smoka, 60 skór czarnego smoka i 10 skór złotego smoka."
	...
	final SpeakerNPC npc = npcs.get("Gulimo");
		npc.add(ConversationStates.ATTENDING, "wielkolud",
				...
				+ " Jest coś co potrzebuję do mojej kolekcji a mianowicie #dragon tusk."
		...
		npc.add(ConversationStates.ATTENDING, Arrays.asList("wielkolud", "kieł", "smok"),
				...
				new PlayerHasItemWithHimCondition("dragon tusk",100)),
				...
				new MultipleActions(new SetQuestAndModifyKarmaAction(QUEST_SLOT, "helmet", 1.0), new DropItemAction("dragon tusk",100)));

		npc.add(ConversationStates.ATTENDING, Arrays.asList("wielkolud", "kieł", "smok"),
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, "kiel_smoka"),
				new NotCondition(new PlayerHasItemWithHimCondition("dragon tusk",100))),
	...
	final SpeakerNPC npc = npcs.get("Krasnolud");
		...
		tookarmoractions.add(new DropItemAction("blue armor"));
		...
		npc.add(ConversationStates.ATTENDING, questTrigger,
				...
				new PlayerHasItemWithHimCondition("blue armor")),
		...
		npc.add(
			...
			new AndCondition(new QuestInStateCondition(QUEST_SLOT, "gotarmor"), new NotCondition(new PlayerHasItemWithHimCondition("blue armor"))),
			ConversationStates.ATTENDING,
