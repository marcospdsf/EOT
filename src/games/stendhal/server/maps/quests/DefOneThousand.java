/* $Id: DefOneThousand.java,v 1.76 2011/11/13 17:13:16 kymara edited by szyg Exp $ */
/***************************************************************************
 ...
 */
public class DefOneThousand extends AbstractQuest {

	private static final String QUEST_SLOT = "DefOneThousand";
	...
	private static void buildItemsMap() {
		...
		items.put("kartka (1000) obrony",1);
	}
	...
	private void getQuest() {
		final SpeakerNPC npc = npcs.get("Daniel");
	...
	private void completeQuest() {
		...
		actions.add(new IncreaseDefXPAction(1000));
	...
	public List<String> getHistory(final Player player) {
		...
		if (repetitions > 0) {
			res.add("Przyniosłem kartkę Danielowi "
