...
public class GazdaWojtekDailyItemQuest extends AbstractQuest {
	...
	private static void buildItemsMap() {
		...
		items.put("highlander chain",1);
		items.put("highlanders corset",1);
		items.put("wooden bolt",10);
		items.put("steel bolt",5);
		items.put("gold bolt",25);
		items.put("fire bolt",10);
		items.put("hatchet",1);
		items.put("ciupaga",1);
		items.put("highlander's shawl",1);
		...
		items.put("highlander helmet",1);
		items.put("highlanders white skirt",1);
		items.put("highlanders skirt",1);
		items.put("beech pants",1);
		...
		items.put("polish wooden shield",1);
		items.put("polish chainmail",1);
		items.put("polish light shield",1);
		items.put("polish plate shield",1);
		items.put("tarcza królewska",1);
		items.put("piłka",1);
		items.put("różdżka",1);
		items.put("różdżka Strzyboga",1);
		items.put("dog bone",20);
		items.put("piórko",30);
		items.put("wolf tusk",20);
		items.put("kieł tygrysi",10);
		items.put("bear tusk",15);
		items.put("wolf claws",10);
		...
		items.put("kryształ rubyu",10);
		items.put("kryształ obsidianu",10);
		items.put("rusted plate armor",1);
