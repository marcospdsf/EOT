...
public class HerbsForJadzka extends AbstractQuest {
	 ...
	 */
	protected static final String NEEDED_ITEMS = "arandula=5;borowik=1;jabłko=3;wood=2;pieczarka=1";
	...
	private void prepareRequestingStep() {
		...
		npc.add(
			...
			null,
			ConversationStates.ATTENDING,
			"Ech... Cóż, niedobrze... Taka twoja wola. Pamintj jednak, że wkrótce zacznę odmawiać potrzebującym leczenia. Będę musiała im powiedzieć, że to przez TWOJE lenistwo.",
		...
		npc.add(
			...
			null,
			ConversationStates.ATTENDING,
			"wood to świetny materiał. Można go wykorzystać na wiele sposobów. Znajdź drzewo w lesie i je zetnij.",
			null);
	...
	private void prepareBringingStep() {
		...
		ChatAction completeAction = new  MultipleActions(
				...
				new EquipItemAction("antidote", 7)
				);
	...
	public void addToWorld() {
		fillQuestInfo(
				"Zioła dla Jadźki",
				"Zakopiański uzdrowiciel Gaździna Jadźka poszukuje składników do antidoteów i lekarstw. Czy moższe jej przynieść jej zioła, które potrzebuje?",
				true);
