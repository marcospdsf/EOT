...
public class DragonsGuard extends AbstractQuest implements LoginListener {
	...
	private static final String CLOAKS_COLLECTOR_2_QUEST_SLOT = "cloaks_collector_2";
			...
			protected void createDialog() {
				...
				add(ConversationStates.IDLE,
						...
						new AndCondition(new GreetingMatchesNameCondition(super.getName()),
								new QuestCompletedCondition(CLOAKS_COLLECTOR_2_QUEST_SLOT),
				...
				add(ConversationStates.IDLE,
						...
						new AndCondition(new GreetingMatchesNameCondition(super.getName()),
							new OrCondition(
									new QuestNotCompletedCondition(CLOAKS_COLLECTOR_2_QUEST_SLOT),
									new QuestNotCompletedCondition(MITHRIL_CLOAK_QUEST_SLOT),
									new QuestNotCompletedCondition(MITHRIL_SHIELD_QUEST_SLOT),
									new QuestNotCompletedCondition(CIUPAGA_DWA_WASY_QUEST_SLOT))),
