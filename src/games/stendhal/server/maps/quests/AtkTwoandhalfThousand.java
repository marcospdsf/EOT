/* $Id: AtkTwoandhalfThousand.java,v 1.76 2011/11/13 17:13:16 kymara edited by szyg Exp $ */
/***************************************************************************
 *                   (C) Copyright 25003-2011 - Stendhal                    *
 ***************************************************************************
 ***************************************************************************
 *                                                                         *
 ...
 */
public class AtkTwoandhalfThousand extends AbstractQuest {

	private static final String QUEST_SLOT = "AtkTwoandhalfThousand";
	...
	private void getQuest() {
		final SpeakerNPC npc = npcs.get("Krzysztof");
	...
	private void completeQuest() {
		...
		actions.add(new IncreaseAtkXPAction(5000));
	...
	public List<String> getHistory(final Player player) {
		...
		res.add("Spotkałem Krzysztofa");
		final String questState = player.getQuest(QUEST_SLOT);
		if ("rejected".equals(questState)) {
			res.add("Nie chcę ataku.");
			return res;
		}
		...
		if (player.hasQuest(QUEST_SLOT) && !player.isQuestCompleted(QUEST_SLOT)) {
			...
			if (!player.isEquipped(questItem, amount)) {
				res.add(("Zostałem poproszony o przyniesienie "
						+ Grammar.quantityplnoun(amount, questItem, "") + ", aby dostać punkty ataku. Nie mam tego jeszcze."));
			} else {
				res.add(("Znalazłem "
						+ Grammar.quantityplnoun(amount, questItem, "") + " by dostać punkty ataku i muszę je dostarczyć."));
			}
		}
		int repetitions = player.getNumberOfRepetitions(getSlotName(), 2);
		if (repetitions > 0) {
			res.add("Przyniosłem kartkę Krzysztofowi "
		...
		if (isRepeatable(player)) {
			...
			res.add("Odebrałem już punkty ataku.");
		}
		return res;
	}
	...
	public void addToWorld() {
		//super.addToWorld();
		fillQuestInfo(
				"Odnawialne co godzine zadanie na punkty ataku",
				"Punkty ataku",
				true);
