...
public class Ratownik extends AbstractQuest {
	...
	private void step1() {
		...
		npc.add(ConversationStates.ATTENDING,
				...
				"Dziękuję za pomoc! Pamintj wychodząc na szlak zostaw wiadomość w schronisku, gdzie idziesz i którą trasą. To zaoszczędzi nam w razie akcji sporo czasu.",
				null);
		...
		npc.add(ConversationStates.QUEST_OFFERED,
				...
				"Jak chcesz, ale pamintj ty też możesz w górach zabłądzić!",
			...
			new ChatAction() {
				public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
					raiser.say("No tak jak wypił to absolutnie nie wolno iść mu z nami na akcję. Niech pomyślę jak cię wynagrodzić?"
								...
								+ " I pamintj w górach nie ma żartów.");
					final Item odznaka = SingletonRepository.getEntityManager().getItem("green dragon claw");
	...
	public List<String> getHistory(final Player player) {
		...
		res.add("Ratownik Mariusz wysłuchał co mam do powiedzenia i w nagrodę za moje zaangażowanie dał mi green dragon claw.");
