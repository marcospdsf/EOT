 ...
 * 
 * 
 * REWARD: <ul><li>2000 XP <li> hatchet </ul>
 * 
				...
				public void fire(final Player player, final Sentence sentence, final EventRaiser npc) {
					...
					if (questions.matches(question, sentence)) {
						...
						if (player.getQuest(TEST_QUEST_SLOT).startsWith("1;1;1")) {
							...
							player.addXP(2000);
							final Item hatchet = SingletonRepository.getEntityManager().getItem("hatchet");
							hatchet.setBoundTo(player.getName());
							player.equipOrPutOnGround(hatchet);
