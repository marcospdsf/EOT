/* $Id: AtkFiveThousand.java,v 1.76 2011/11/13 17:13:16 kymara edited by szyg Exp $ */
/***************************************************************************
 *                   (C) Copyright 50003-2011 - Stendhal                    *
 ***************************************************************************
 ***************************************************************************
 *                                                                         *
 ...
 */
public class AtkFiveThousand extends AbstractQuest {

	private static final String QUEST_SLOT = "AtkFiveThousand";
	...
	private void getQuest() {
		final SpeakerNPC npc = npcs.get("Tomasz");
	...
	private void completeQuest() {
		...
		actions.add(new IncreaseAtkXPAction(1000));
	...
	public List<String> getHistory(final Player player) {
		...
		if (repetitions > 0) {
			res.add("Przyniosłem kartkę Tomaszowi "
