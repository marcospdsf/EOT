...
public class KillDragons extends AbstractQuest {
	...
	private void step1() {
		...
		npc.add(ConversationStates.QUEST_OFFERED,
				...
				+ " Jeśli włożę je pod poduszkę, będą odstraszać koszmary. Pamintj, że musisz zabić go samodzielnie, bo skóra nie będzie działała jak talizman!",
	...
	private void step2() {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"start"),
								 ...
								 new NotCondition(new PlayerHasItemWithHimCondition("green dragon skin", 5))),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"start"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new PlayerHasItemWithHimCondition("green dragon skin", 5)),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
						...
						player.drop("green dragon skin", 5);
						player.addKarma(10);
	...
	private void czas1() {
		...
		npc.add(ConversationStates.ATTENDING, Arrays.asList("pomożesz", "pomozesz", "pomogę"),
					...
					+ " Pamintj, że musisz zabić go samodzielnie, bo kości nie będą działały jak talizman!",
				new MultipleActions(actions));
	}
	...
	private void step3() {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"szkielet"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new NotCondition(new PlayerHasItemWithHimCondition("dog bone", 20))),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
			new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"szkielet"),
							 new KilledForQuestCondition(QUEST_SLOT, 1),
							 new PlayerHasItemWithHimCondition("dog bone", 20)),
			ConversationStates.ATTENDING, null,
			new ChatAction() {
				@Override
				public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
	...
	private void czas2() {
		...
		npc.add(ConversationStates.ATTENDING, Arrays.asList("pomożesz", "pomozesz", "pomoge"),
				...
				+ " Pamintj, że musisz zabić go samodzielnie, bo skóry nie będą działały jak talizman!",
				new MultipleActions(actions));
	}
	...
	private void step5() {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"zgnily"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new NotCondition(new PlayerHasItemWithHimCondition("dog bone", 30))),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"zgnily"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new PlayerHasItemWithHimCondition("dog bone", 30)),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
	...
	private void step6() {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"czerwony"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new NotCondition(new PlayerHasItemWithHimCondition("red dragon skin", 5))),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"czerwony"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new PlayerHasItemWithHimCondition("red dragon skin", 5)),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
	...
	private void step7() {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"pustynny"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new NotCondition(new PlayerHasItemWithHimCondition("golden dragon skin", 5))),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"pustynny"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new PlayerHasItemWithHimCondition("golden dragon skin", 5)),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
						...
						player.drop("golden dragon skin", 5);
						player.addKarma(10);
	...
	private void step10() {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"dwu_zielony"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new NotCondition(new PlayerHasItemWithHimCondition("green dragon skin", 10))),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"dwu_zielony"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new PlayerHasItemWithHimCondition("green dragon skin", 10)),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
						...
						player.drop("green dragon skin", 10);
						player.addKarma(10);
	...
	private void czas9() {
		...
		npc.add(ConversationStates.ATTENDING, Arrays.asList("pomożesz", "pomozesz", "pomoge"),
				...
				+ " Pamintj, że musisz zabić go samodzielnie, bo kły nie będą działały jak talizman!",
				new MultipleActions(actions));
	}
	...
	private void step11() {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"arktyczny"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new NotCondition(new PlayerHasItemWithHimCondition("dragon tusk", 10))),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"arktyczny"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new PlayerHasItemWithHimCondition("dragon tusk", 10)),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
	...
	private void step12() {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"dru_czerwony"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new NotCondition(new PlayerHasItemWithHimCondition("red dragon skin", 10))),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"dru_czerwony"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new PlayerHasItemWithHimCondition("red dragon skin", 10)),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
						...
						player.drop("red dragon skin", 10);
						player.addKarma(10);
	...
	private void step13() {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"czarny"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new NotCondition(new PlayerHasItemWithHimCondition("black dragon skin", 15))),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"czarny"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new PlayerHasItemWithHimCondition("black dragon skin", 15)),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
						...
						player.drop("black dragon skin", 15);
						player.addKarma(10);
	...
	private void step14() {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"dwuglowy_czarny"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new NotCondition(new PlayerHasItemWithHimCondition("black dragon skin", 25))),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"dwuglowy_czarny"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new PlayerHasItemWithHimCondition("black dragon skin", 25)),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
						...
						player.drop("black dragon skin", 25);
						player.addKarma(10);
	...
	private void czas13() {
		...
		npc.add(ConversationStates.ATTENDING, Arrays.asList("pomożesz", "pomozesz", "pomoge"),
				...
				+ " Pamintj, że musisz zabić go samodzielnie, bo pazury nie będą działały jak talizman!",
				new MultipleActions(actions));
	}
	...
	private void step15() {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"czar_latajacy"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new NotCondition(new PlayerHasItemWithHimCondition("black dragon's claw", 2))),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"czar_latajacy"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new PlayerHasItemWithHimCondition("black dragon's claw", 2)),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
						...
						player.drop("black dragon's claw", 2);
						player.addKarma(150);
						final StackableItem potion = (StackableItem) SingletonRepository.getEntityManager().getItem("mega potion");
	...
	private void czas14() {
		...
		npc.add(ConversationStates.ATTENDING, Arrays.asList("pomożesz", "pomozesz", "pomoge"),
				...
				+ " Przynieś mi też jego 1 gold dragon claw. Jeśli włożę go pod poduszkę, będzie odstraszał koszmary."
				+ " Pamintj, że musisz zabić go samodzielnie, bo pazur nie będzie działał jak talizman!",
				new MultipleActions(actions));
	}
	...
	private void step16() {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"latajacy_zloty"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new NotCondition(new PlayerHasItemWithHimCondition("gold dragon claw"))),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
						raiser.say("Nawet jeśli zabiłeś smoka, na pewno odwiedzi mnie ponownie w koszmarze jeśli nie będę miała amuletu. Proszę, dostarcz mi gold dragon claw.");
					}
				});
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"latajacy_zloty"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new PlayerHasItemWithHimCondition("gold dragon claw")),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
						...
						player.drop("gold dragon claw");
						player.addKarma(150);
						final StackableItem potion1 = (StackableItem) SingletonRepository.getEntityManager().getItem("mega potion");
	...
	private void czas15() {
		...
		npc.add(ConversationStates.ATTENDING, Arrays.asList("pomożesz", "pomozesz", "pomoge"),
				...
				+ " Przynieś mi też jego 1 green dragon claw. Jeśli włożę go pod poduszkę, będzie odstraszał koszmary."
				+ " Pamintj, że musisz zabić go samodzielnie, bo pazur nie będzie działał jak talizman!",
				new MultipleActions(actions));
	...
	private void step17() {
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"wawelski"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new NotCondition(new PlayerHasItemWithHimCondition("green dragon claw"))),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
						raiser.say("Nawet jeśli zabiłeś smoka, na pewno odwiedzi mnie ponownie w koszmarze jeśli nie będę miała amuletu. Proszę, przynieś mi green dragon claw, o który prosiłam.");
					}
				});
		...
		npc.add(ConversationStates.IDLE, ConversationPhrases.GREETING_MESSAGES,
				new AndCondition(new QuestInStateCondition(QUEST_SLOT, 0,"wawelski"),
								 new KilledForQuestCondition(QUEST_SLOT, 1),
								 new PlayerHasItemWithHimCondition("green dragon claw")),
				ConversationStates.ATTENDING, null,
				new ChatAction() {
					@Override
					public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
