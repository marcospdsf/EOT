/* $Id: AtkOneThousand.java,v 1.76 2011/11/13 17:13:16 kymara edited by szyg Exp $ */
/***************************************************************************
 *                   (C) Copyright 10003-2011 - Stendhal                    *
 ***************************************************************************
 ***************************************************************************
 *                                                                         *
 ...
 */
public class AtkOneThousand extends AbstractQuest {

	private static final String QUEST_SLOT = "AtkOneThousand";
	...
	private void getQuest() {
		final SpeakerNPC npc = npcs.get("Norbert");
	...
	private void completeQuest() {
		...
		actions.add(new IncreaseAtkXPAction(2500));
	...
	public List<String> getHistory(final Player player) {
		...
		if (repetitions > 0) {
			res.add("Przyniosłem kartkę Norbertowi "
