/* $Id: DefTwoandhalfThousand.java,v 1.76 2011/11/13 17:13:16 kymara edited by szyg Exp $ */
/***************************************************************************
 ...
 */
public class DefTwoandhalfThousand extends AbstractQuest {

	private static final String QUEST_SLOT = "DefTwoandhalfThousand";
	...
	private static void buildItemsMap() {
		...
		items.put("kartka (2500) obrony",1);
	}
	...
	private void getQuest() {
		final SpeakerNPC npc = npcs.get("Szymon");
	...
	private void completeQuest() {
		...
		actions.add(new IncreaseDefXPAction(2500));
	...
	public List<String> getHistory(final Player player) {
		...
		if (repetitions > 0) {
			res.add("Przyniosłem kartkę Szymonowi "
