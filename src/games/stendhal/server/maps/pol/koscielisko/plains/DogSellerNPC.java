		...
		final SpeakerNPC npc = new SpeakerNPC("Stary Baca") {
			...
			protected void createDialog() {
					...
					public boolean transactAgreedDeal(ItemParserResult res, final EventRaiser seller, final Player player) {
						if (res.getAmount() > 1) {
							...
							if (res.getChosenItemName().equals("owczarek podhalański")) {
								...
								seller.say("Proszę bardzo, mały owczarek podhalański! Twój owczarek żywi się udkiem, mięsem, szynką, kiełbasą swojską, steakiem, goat cheese lub żyntycą. Ciesz się!");
								...
								seller.say("Proszę bardzo oto mały owczarek! Twój owczarek żywi się udkiem, mięsem, szynką, kiełbasą swojską, steakiem, goat cheese lub żyntycą. Ciesz się!");
				...
				addReply(Arrays.asList("care", "zaopiekujesz", "opiekować"),
						"Owczarki kochają meat, ham, kiełbasa swojska, steak i goat cheese. Wystarczy położyć kawałek na ziemi, a owczarek podejdzie i zje. Możesz sprawdzić jego wagę klikając prawym przyciskiem  na niego i wybierając 'Zobacz'. Jego waga będzie rosła po zjedzeniu każdego ham.");
