/* $Id: SemosKonfident.java,v 1.19 2010/09/19 09:45:27 kymara Exp $ */
/***************************************************************************
...
public class SemosKonfident implements ZoneConfigurator {
	/**
	 * Configure a zone.
	 *
	...
	private void buildElementalArea(final StendhalRPZone zone) {
		final SpeakerNPC elemental = new SpeakerNPC("Urzędnik Semos") {
			...
			protected void createDialog() {
				addGreeting("Dzień dobry, jestem urzędnikiem Semos. Zajmuje się sprawami związanymi z administracją i przyznaje odznaczenia.");
		...
		elemental.setDescription("Oto Urzędnik Semos.");
		elemental.setEntityClass("urzedniknpc");
		elemental.setPosition(17, 33);
