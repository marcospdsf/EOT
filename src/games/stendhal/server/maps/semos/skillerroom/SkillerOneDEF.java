/* $Id: SkillerOneDEF.java,v 1.4 2010/09/19 02:30:47 nhnb Exp $ */
/***************************************************************************
 ...
 * @author davvids
 */
public class SkillerOneDEF implements ZoneConfigurator {
	//
	// ZoneConfigurator
	//
	...
	private void buildNPC(final StendhalRPZone zone, final Map<String, String> attributes) {
		final SpeakerNPC SkillerOneDEF = new SpeakerNPC("Tadeusz") {
		...
		SkillerOneDEF.setEntityClass("DefNPC3");
		SkillerOneDEF.setPosition(4, 4);
		SkillerOneDEF.initHP(100);
		SkillerOneDEF.setDescription("Oto Tadeusz.");
		zone.add(SkillerOneDEF);
	}
}
