/* $Id: SkillerTwoDEF.java,v 1.4 2010/09/19 02:30:47 nhnb Exp $ */
/***************************************************************************
 ...
 * @author davvids
 */
public class SkillerTwoDEF implements ZoneConfigurator {
	//
	// ZoneConfigurator
	//
	...
	private void buildNPC(final StendhalRPZone zone, final Map<String, String> attributes) {
		final SpeakerNPC SkillerTwoDEF = new SpeakerNPC("Norbert") {
		...
		SkillerTwoDEF.setEntityClass("DefNPC4");
		SkillerTwoDEF.setPosition(4, 30);
		SkillerTwoDEF.initHP(100);
		SkillerTwoDEF.setDescription("Oto Norbert.");
		zone.add(SkillerTwoDEF);
	}
}
