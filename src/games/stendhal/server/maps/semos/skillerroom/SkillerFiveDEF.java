/* $Id: SkillerFiveDEF.java,v 1.4 2010/09/19 02:30:47 nhnb Exp $ */
/***************************************************************************
 ...
 * @author davvids
 */
public class SkillerFiveDEF implements ZoneConfigurator {
	//
	// ZoneConfigurator
	//
	...
	private void buildNPC(final StendhalRPZone zone, final Map<String, String> attributes) {
		final SpeakerNPC SkillerFiveDEF = new SpeakerNPC("Krzysztof") {
		...
		SkillerFiveDEF.setEntityClass("DefNPC5");
		SkillerFiveDEF.setPosition(4, 40);
		SkillerFiveDEF.initHP(100);
		SkillerFiveDEF.setDescription("Oto Krzysztof.");
		zone.add(SkillerFiveDEF);
	}
}
