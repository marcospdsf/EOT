/* $Id: SkillerFiveATK.java,v 1.4 2010/09/19 02:30:47 nhnb Exp $ */
/***************************************************************************
 ...
 * @author davvids
 */
public class SkillerFiveATK implements ZoneConfigurator {
	//
	// ZoneConfigurator
	//
	...
	private void buildNPC(final StendhalRPZone zone, final Map<String, String> attributes) {
		final SpeakerNPC SkillerFiveATK = new SpeakerNPC("Jan") {
		...
		SkillerFiveATK.setEntityClass("AtkNPC1");
		SkillerFiveATK.setPosition(40, 40);
		SkillerFiveATK.initHP(100);
		SkillerFiveATK.setDescription("Oto Jan.");
		zone.add(SkillerFiveATK);
	}
}
