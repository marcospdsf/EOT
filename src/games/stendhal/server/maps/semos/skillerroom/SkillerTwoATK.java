/* $Id: SkillerTwoATK.java,v 1.4 2010/09/19 02:30:47 nhnb Exp $ */
/***************************************************************************
 ...
 * @author davvids
 */
public class SkillerTwoATK implements ZoneConfigurator {
	//
	// ZoneConfigurator
	//
	...
	private void buildNPC(final StendhalRPZone zone, final Map<String, String> attributes) {
		final SpeakerNPC SkillerTwoATK = new SpeakerNPC("Szymon") {
		...
		SkillerTwoATK.setEntityClass("AtkNPC4");
		SkillerTwoATK.setPosition(40, 30);
		SkillerTwoATK.initHP(100);
		SkillerTwoATK.setDescription("Oto Szymon.");
		zone.add(SkillerTwoATK);
	}
}
