/* $Id: SkillerThreeDEF.java,v 1.4 2010/09/19 02:30:47 nhnb Exp $ */
/***************************************************************************
 ...
 * @author davvids
 */
public class SkillerThreeDEF implements ZoneConfigurator {
	//
	// ZoneConfigurator
	//
	...
	private void buildNPC(final StendhalRPZone zone, final Map<String, String> attributes) {
		final SpeakerNPC SkillerThreeDEF = new SpeakerNPC("Tomasz") {
		...
		SkillerThreeDEF.setEntityClass("DefNPC3");
		SkillerThreeDEF.setPosition(4, 22);
		SkillerThreeDEF.initHP(100);
		SkillerThreeDEF.setDescription("Oto Tomasz.");
		zone.add(SkillerThreeDEF);
	}
}
