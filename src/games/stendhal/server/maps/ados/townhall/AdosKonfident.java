/* $Id: AdosKonfident.java,v 1.19 2010/09/19 09:45:27 kymara Exp $ */
/***************************************************************************
...
public class AdosKonfident implements ZoneConfigurator {
	/**
	 * Configure a zone.
	 *
	...
	private void buildElementalArea(final StendhalRPZone zone) {
		final SpeakerNPC elemental = new SpeakerNPC("Urzędnik Ados") {
			...
			protected void createDialog() {
				addGreeting("Dzień dobry, jestem urzędnikiem Ados. Zajmuje się sprawami związanymi z administracją i przyznaje odznaczenia.");
		...
		elemental.setDescription("Oto Urzędnik Ados.");
		elemental.setEntityClass("urzedniknpc");
		elemental.setPosition(14, 5);
