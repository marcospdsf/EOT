/* $Id: SoldierNPC.java,v 1.19 2012/08/11 12:41:45 bluelads99 Exp $ */
/***************************************************************************
	...
	private void buildAdosGreetingSoldier(final StendhalRPZone zone) {
		...
		final SpeakerNPC npc = new SpeakerNPC("Julius") {
			...
			protected void createDialog() {
				addGreeting("Witam. Słyszałeś najnowsze wieści? Mała dziewczynka o imieniu #Susi zaginęła i teraz całe miasto jej szuka.");
				...
				addJob("Chronię miasto Ados przed szabrownikami, gdy większość mieszkańców wybrała się na poszukiwania dziewczynki.");
				addHelp("Rozejrzyj się. Kilka osób wciąż jest w Ados i pracuje.");
				addGoodbye("Mam nadzieje, że dobrze będziesz się bawił w Ados.");
			}
		};
