...
//		loadQuest(new AtkTwoHundred());
//		loadQuest(new AtkFiveHundred());
//		loadQuest(new AtkOneThousand());
//		loadQuest(new AtkTwoandhalfThousand());
//		loadQuest(new AtkFiveThousand());
//		loadQuest(new DefTwoHundred());
//		loadQuest(new DefFiveHundred());
//		loadQuest(new DefOneThousand());
//		loadQuest(new DefTwoandhalfThousand());
//		loadQuest(new DefFiveThousand());
//		loadQuest(new GoldApple());
