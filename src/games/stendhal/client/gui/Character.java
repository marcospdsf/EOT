...
Inspectable {
	...
	private void createLayout() {
		...
		right.add(panel);
		panel = createItemPanel(itemClass, store, "finger2", "data/gui/ring-slot.png");
		right.add(panel);

	
		// Bag, keyring, scrollbag, etc
		...
		panel = createItemPanel(itemClass, store, "smallbag", "data/gui/key-slot.png");
		//specialSlots.add(panel);
		panel = createItemPanel(itemClass, store, "holder", "data/gui/key-slot.png");
