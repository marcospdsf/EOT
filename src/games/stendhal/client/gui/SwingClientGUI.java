...
class SwingClientGUI implements J2DClientGUI {
	...
	/** the Scroll Bag panel. */
	private ScrollBag scrollbag;
	/** the Weapon Bag panel. */
	...
	private ContainerPanel createContainerPanel() {
		...
		scrollbag = new ScrollBag();
		scrollbag.setAcceptedTypes(EntityMap.getClass("item", null, null));
		containerPanel.addRepaintable(scrollbag);
		userContext.addFeatureChangeListener(scrollbag);
	...
	public void updateUser(User user) {
		...
		scrollbag.setSlot(user, "scrollbag");
		weaponbag.setSlot(user, "weaponbag");
