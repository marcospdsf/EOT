...
public final class StatsPanelController {
	...
	*/
	...
	/**
	 * Listener for miningLevel and mining_xp changes.
	 */
	private class MiningChangeListener implements PropertyChangeListener {
		...
		public void propertyChange(final PropertyChangeEvent event) {
			...
			} else if ("miningLevel".equals(event.getPropertyName())) {
				miningLevel =  Integer.parseInt((String) event.getNewValue());
			}
			updateMiningLevel();
		}
	}
