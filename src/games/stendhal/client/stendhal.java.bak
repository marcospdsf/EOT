...
public final class stendhal {
	...
	private static void initUsableDisplaySizes() {
		...
		displaySizes.add(new Dimension(1024, 768)); // Smaller 4:3 (1024x768 and smaller)
		displaySizes.add(new Dimension(1024, 768)); // Larger 4:3 (1280x1024)
		displaySizes.add(new Dimension(1024, 768)); // Larger 16:9 (1366x768 and larger)
	}
